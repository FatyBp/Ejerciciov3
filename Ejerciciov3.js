var Ejerciciov3 = /** @class */ (function () {
    function Ejerciciov3() {
    }
    Ejerciciov3.prototype.Ejercicio1 = function () {
        // Ejercicio 1
        ...
        var inicio;
        var final;
        var uva = String(prompt('Ingrese el tipo de uva (A o B):' !== null && 'Ingrese el tipo de uva (A o B):' !== void 0 ? 'Ingrese el tipo de uva (A o B):' : ""));
        var tamanoUva = prompt('Ingrese el tama\xF1o de la uva (1 o 2):');
        var kilos = Number(prompt('Ingrese la cantidad de kilos de uva entregados:'));
    ...
    Ejerciciov3.prototype.Ejercicio2 = function () {
        ...
        var alumnos = (_a = prompt("Ingrese el número de alumnos que participarán en el viaje:")) !== null && _a !== void 0 ? _a : "  ";
        // Convertimos el valor ingresado a un número entero
        var cantidad = parseInt(alumnos);
        ...
        if (cantidad >= 100 ? Number(costo = 65)
            ...
            var costoxAlumno = costoTotal / cantidad;
    ...
    Ejerciciov3.prototype.Ejercicio3 = function () {
        var _a;
        // Ejercicio 3
        ...
        // una llamada.
        var tiempoLlamada = Number((_a = prompt('cuanto duro la llamada?\n en minutos')) !== null && _a !== void 0 ? _a : "");
        var domingo = true;
        var respuesta = domingo ? "Si" : "No";
        var turno = true;
        var respuesta2 = turno ? "Dia" : "Tarde";
        function costosLlamada(tiempoLlamada, domingo, turno) {
            var costoTotal = 0;
        ...
        var costoTotal = costosLlamada(tiempoLlamada, domingo, turno);
